...
public class VaultLooterOverlay extends OverlayPanel {
    public final ButtonComponent myButton;
    @Inject
    VaultLooterOverlay(VaultLooterPlugin plugin)
    {
        super(plugin);
        ...
        myButton.setOnClick(() -> Microbot.openPopUp("Microbot", String.format("S-1D:<br><br><col=ffffff>%s Popup</col>", "VaultLooter")));
    }
    @Override
