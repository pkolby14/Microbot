...
public class RevBotOverlay extends OverlayPanel {
    public final ButtonComponent myButton;
    @Inject
    RevBotOverlay(RevBotPlugin plugin)
    {
        super(plugin);
        ...
        myButton.setOnClick(() -> Microbot.openPopUp("Microbot", String.format("S-1D:<br><br><col=ffffff>%s Popup</col>", "RevBot")));
    }
    @Override
